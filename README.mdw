...
### Promise
- ES6 부터 자바스크립트와 노드의 API들이 '콜백 대신에!! 프로미스 기반으로 재구성됨'
	- 즉, '콜백 받는 API는 promise 라는 것 기반으로 구현해라' 라는 말
 ...
 *	1. then 에는 API가 성공적으로 호출 되었을 경우 불릴 콜백(AIP 구현시 resolve param)이고, 
